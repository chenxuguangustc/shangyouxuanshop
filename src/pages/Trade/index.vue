<template>
  <div class="trade-container">
    ...
    <div class="sub clearFix">
      <!-- 声明式导航一点击就跳转过去了，做不了其他的操作，所以这里使用编程式导航 -->
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let { detailArrayList, couponInfoList } = this.tradeInfo;
      let { consignee, phoneNum, userAddress } = this.selectAddress;
